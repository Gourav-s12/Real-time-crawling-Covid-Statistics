...
###DEFINING TOKENS###
tokens = ('OH2', 'CH2', 'EDIT', 'OH3', 'CH3', 'SKIP', 'END', 'STYLE', 'OLII',
'OT', 'CT', 'OR', 'CR',
'OPENHEADER', 'CLOSEHEADER', 'OHF', 'CEF',
'CNTT', 'OPENDATA', 'CLOSEDATA' ,'OAN',
'CLN', 'OPV', 'CDV', 'OSE', 'CLST','GRB')
t_ignore = '\t'
